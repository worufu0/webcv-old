    ...
    e.fn.pagepiling = function (i) {
        ...
        function c(n, t) {
            var o = {
                ...
                yMovement: s(n),
                leavingSection:
                    e('.pp-section.active').index('.pp-section') + 1,
            };
                ...
                if ((i.length || n.preventDefault(), !m())) {
                    ...
                    (K = a.y),
                        ...
                        Math.abs(H - V) > Math.abs(j - K)
                            ? Math.abs(H - V) >
                                  (F.width() / 100) * Z.touchSensitivity &&
                              (H > V ? x('down', i) : V > H && x('up', i))
                            : Math.abs(j - K) >
                                  (F.height() / 100) * Z.touchSensitivity &&
        ...
        function O() {
            ...
            return (
                n.body.removeChild(i), e !== o && e.length > 0 && 'none' !== e
            );
        }
        function U() {
